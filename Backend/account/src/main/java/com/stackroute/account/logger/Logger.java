package com.stackroute.account.logger;
...
public class Logger {
    ...
    @Before(value = "execution(* com.stackroute.account.controller.AccountController .*(..))")
    public void beforeAdvice(JoinPoint joinPoint) {
        logger.info("Entering method : " + joinPoint.getSignature().getName());
    }

    @After(value = "execution(* com.stackroute.account.controller.AccountController .*(..))")
    public void afterAdvice(JoinPoint joinPoint) {
        logger.info("Exited Method : " + joinPoint.getSignature().getName());
    }


    @AfterReturning(value = "execution(* com.stackroute.account.controller.AccountController .*(..))", returning = "responseEntity")
    ...
    @AfterThrowing(value = "execution(* com.stackroute.account.controller.AccountController .*(..))", throwing = "exception")
