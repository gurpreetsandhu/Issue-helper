package com.stackroute.query.logger;
...
public class Logger {
    ...
    @Before(value = "execution(* com.stackroute.query.controller.QueryController .*(..))")
    public void beforeAdvice(JoinPoint joinPoint) {
        logger.info("Entering method : " + joinPoint.getSignature().getName());
    }

    @After(value = "execution(* com.stackroute.query.controller.QueryController .*(..))")
    public void afterAdvice(JoinPoint joinPoint) {
        logger.info("Exited Method : " + joinPoint.getSignature().getName());
    }


    @AfterReturning(value = "execution(* com.stackroute.query.controller.QueryController .*(..))", returning = "responseEntity")
    ...
    @AfterThrowing(value = "execution(* com.stackroute.query.controller.QueryController .*(..))", throwing = "exception")
